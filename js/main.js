...
E(document).ready(function () {
    ...
    if (localStorage.getItem('htmlcode') === null) {
        var defaultHTML = '<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script>\n<main>\n    <h1>Editor<\/h1>\n    <p>It\'s an editor.<\/p>\n<\/main>';
    ...
    E('.reset-editor').on('click', function () {
        editorHTML.setValue('<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script>\n<main>\n    <h1>Editor<\/h1>\n    <p>It\'s an editor.<\/p>\n<\/main>');
